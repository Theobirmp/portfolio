...
const ProjectsNew = () => {
  return (
    ...
    <motion.div
      ...
      exit={{ opacity: 0 }}
      className="pb-10 min-h-screen flex flex-col justify-center items-center"
    >
      {/* projects container */}
      <div className="mt-52 flex flex-col gap-10 justify-center items-center">
        ...
        <motion.div
          ...
          className="grid overflow-hidden grid-cols-1 md:grid-cols-2 xl:grid-cols-3 auto-rows-fr grid-flow-row gap-10"
        >
